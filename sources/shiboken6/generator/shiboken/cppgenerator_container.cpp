                                                        ...
                                                        QSet<AbstractMetaType> *valueTypes) const
{
    ...
    const QString pyArg = u"pyArg"_s;
    s << "static int " << result.checkFunctionName << "(PyObject *" << pyArg
    ...
    s << "static void " << result.pythonToConverterFunctionName
    ...
    s << "static PythonToCppFunc " << result.converterCheckFunctionName
        << "(PyObject *" << pyArg << ")\n{\n" << indent << "if ("
